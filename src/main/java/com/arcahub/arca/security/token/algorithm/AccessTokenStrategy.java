...
import com.arcahub.arca.security.secret.Secrets;
...
public class AccessTokenStrategy implements TokenStrategy {
    private final String secret = Secrets.JWT_SECRET;
    private final long expiration = Secrets.ACCESS_JWT_EXPIRE_IN;
